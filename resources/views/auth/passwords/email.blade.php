...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 mt-8">
            <div class="card">
                <div class="card-header"><h1 class="h-first hf-he hf-contact-header hf-center">Reset Password</h1></div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('password.email') }}" class="hf-form">
                        @csrf
